...
TIPTILT_TEST_LIMIT_ARCMIN = float(os.environ.get("AO_V4_1_TIPTILT_TEST_LIMIT_ARCMIN", "6.0"))
...
TT_DOMINANT_XYZ_BIAS_WEIGHT = float(os.environ.get("AO_V4_1_TT_DOMINANT_XYZ_BIAS_WEIGHT", "0.03"))
TT_LOCAL_VARIANCE_WEIGHT = float(os.environ.get("AO_V4_1_TT_LOCAL_VARIANCE_WEIGHT", "0.02"))
...
def run_repair(config: RunConfig, log: LogCallback | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        summary = {
            "status": "complete",
            "algorithm": "adaptive_optics_v4_1_global_tt_first_block_search",
            "configuration": {
                "wavelength_nm": float(bench.WAVELENGTH_NM),
                "object_space_mm": float(bench.OBJECT_SPACE_MM),
                "reference_focus_mm": float(bench.REFERENCE_FOCUS_MM),
