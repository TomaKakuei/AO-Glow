...
WORKER_PATH = ROOT / "ao_v4_1_worker.py"
...
class AdaptiveOpticsV41App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V4.1 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V4.1", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V4.1 uses a hidden-plant closed loop with global-TT-first refinement and the same truth constraints as V4.",
