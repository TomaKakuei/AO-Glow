...
CSV_PATH = ARTIFACTS_DIR / "v5_avg4_random_xy022_narrow_ttscaled_10cases.csv"
JSON_PATH = ARTIFACTS_DIR / "v5_avg4_random_xy022_narrow_ttscaled_10cases.json"
...
def main() -> int:
    ...
    for case_index, overall_variation_mm, tt_arcmin in _case_specs():
        ...
        output_name = f"v5_avg4_random_xy022_narrow_ttscaled_case{case_index:02d}"
        config = RunConfig(
