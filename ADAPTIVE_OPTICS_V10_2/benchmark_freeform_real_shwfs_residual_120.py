...
SHWFS_SIGNATURE_NOISE_SAMPLES = _env_int("AO_V10_SHWFS_SIGNATURE_NOISE_SAMPLES", _env_int("AO_V9_SHWFS_SIGNATURE_NOISE_SAMPLES", 8))
SHWFS_CANONICAL_ACTIVE_LENSLETS = _env_int("AO_V10_CANONICAL_ACTIVE_LENSLETS", _env_int("AO_V9_CANONICAL_ACTIVE_LENSLETS", 128))
...
def configure_shwfs_runtime(
    *,
    ...
    canonical_active_lenslets: int | None = None,
) -> None:
    global LENSLET_COUNT, SHWFS_SLOPE_LIMIT, SHWFS_NOISE_PROFILE, SHWFS_CALIBRATION_NOISE_PROFILE, SHWFS_NOISE_SEED, SHWFS_LENSLET_PIXEL_COUNT, SHWFS_FORWARD_AVERAGES, SHWFS_CANONICAL_ACTIVE_LENSLETS
    ...
    if canonical_active_lenslets is not None:
        SHWFS_CANONICAL_ACTIVE_LENSLETS = max(0, int(canonical_active_lenslets))
