...
WORKER_PATH = ROOT / "ao_v9_worker.py"
...
class AdaptiveOpticsV9App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V9 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V9", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V9 keeps the hidden-plant truth boundary and adds a sensor-normalized block scheduler for cross-sensor compatibility.",
