...
WORKER_PATH = ROOT / "ao_v10_2_worker.py"
...
class AdaptiveOpticsV10App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V10.2 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V10.2", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        noise_combo = ttk.Combobox(
            ...
            values=("none", "minimal", "realistic", "hard"),
            width=12,
            state="readonly",
        )
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V10.2 keeps the hidden-plant truth boundary, binds each profile to a tested sensor geometry for cross-sensor compatibility, and is the 12-mode analysis branch.",
