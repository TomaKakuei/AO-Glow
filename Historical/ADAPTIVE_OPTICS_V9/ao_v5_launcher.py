...
WORKER_PATH = ROOT / "ao_v5_worker.py"
...
class AdaptiveOpticsV5App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V5 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V5", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V5 keeps the hidden-plant truth boundary but upgrades SHWFS forward simulation to a 13x13 electron-domain noisy sensor model.",
