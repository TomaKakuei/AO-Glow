...
WORKER_PATH = ROOT / "ao_v10_worker.py"
...
class AdaptiveOpticsV10App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V10 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V10", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V10 keeps the hidden-plant truth boundary and binds each profile to a tested sensor geometry for cross-sensor compatibility.",
