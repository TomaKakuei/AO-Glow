...
WORKER_PATH = ROOT / "ao_v4_worker.py"
...
class AdaptiveOpticsV4App:
    def __init__(self, root: tk.Tk) -> None:
        self.root = root
        self.root.title("Adaptive Optics V4 Launcher")
    ...
    def _build_ui(self) -> None:
        ...
        top = ttk.Frame(outer)
        top.pack(fill="x")
        ttk.Label(top, text="Adaptive Optics V4", font=("Segoe UI", 16, "bold")).pack(anchor="w")
        ...
        ttk.Label(
            config_frame,
            text="Per-anchor override fields are requested dx / dy / dz in mm. V4 uses SHWFS-guided block search with the same closed-loop truth constraints as V3.",
