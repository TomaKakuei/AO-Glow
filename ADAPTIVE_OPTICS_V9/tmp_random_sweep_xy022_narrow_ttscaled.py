...
CSV_PATH = ARTIFACTS_DIR / "v5_random_xy022_narrow_ttscaled_10cases.csv"
JSON_PATH = ARTIFACTS_DIR / "v5_random_xy022_narrow_ttscaled_10cases.json"
...
def _configure_env(tt_arcmin: float) -> None:
    ...
    os.environ["AO_V5_SHWFS_FORWARD_AVERAGES"] = "1"
...
def main() -> int:
    ...
    for case_index, overall_variation_mm, tt_arcmin in _case_specs():
        ...
        if "ao_v5_backend" in sys.modules:
            importlib.reload(sys.modules["ao_v5_backend"])
        ...
        output_name = f"v5_random_xy022_narrow_ttscaled_case{case_index:02d}"
        config = RunConfig(
